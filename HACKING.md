...
hidden if the `clgof_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `clgof_DEVELOPER_MODE` to the configure
...
Runs the executable target `clgof_exe`.
